...
class UserGroupCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\UserGroup');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/user_group');
        $this->crud->setEntityNameStrings('User Group', 'User Groups');
