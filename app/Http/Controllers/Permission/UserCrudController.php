...
class UserCrudController extends CrudController
{
    public function setup()
    {
        ...
        if (config('backpack.permissionmanager.allow_user_create') == false) {
            $this->crud->denyAccess('create');
        }
        if (config('backpack.permissionmanager.allow_user_update') == false) {
            $this->crud->denyAccess('update');
        }
        if (config('backpack.permissionmanager.allow_user_delete') == false) {
