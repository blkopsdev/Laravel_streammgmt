...
<html lang="en">
  <head>
    ...
    <title>Join Bridges / Streams</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
          <h1 class="text-center">Stream and Conference Joining Tool</h1>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="panel panel-primary">
            <div class="panel-heading">
              <h2 class="panel-title"><i class="fa fa-headphones"></i> Join Bridges Only</h2>
            </div>
            <div class="panel-body">
		<input placeholder="Source Bridge ID" type="text" class="form-control" id="sourceBridge"/>
		<input placeholder="Destination Bridge ID" type="text" class="form-control" id="sourceBridge"/>
		<input placeholder="Destination Bridge PIN" type="text" class="form-control" id="sourceBridge"/>
		<input placeholder="Max Minutes Connection" type="number" min="5" max="180" class="form-control" id="sourceBridge"/>
              ...
              <br>
              <div align="center">
                <a class="btn btn-default btn-xs" role="button" href="http://icecast.aleph-com.net:8000/<?php echo $mount->mount; ?>.mp3">http://icecast.aleph-com.net:8000/<?php echo $mount->mount; ?>.mp3</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="panel panel-primary">
            <div class="panel-heading">
              <h3 class="panel-title"><i class="fa fa-music"></i> Audio File</h3>
            </div>
            <div class="panel-body">
